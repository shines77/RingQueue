//
// URL:
//   http://www.dotnetframework.org/default.aspx/4@0/4@0/DEVDIV_TFS/Dev10/Releases/RTMRel/ndp/clr/src/BCL/System/Threading/SpinWait@cs/1305376/SpinWait@cs
//
// ==++==
//
...
namespace System.Threading
{
    ...
    /// the <see cref="SpinWait"> type should be preferred over the <see cref="System.Threading.Thread.SpinWait"> method.
    /// </see></see></see></see></para>
    /// <para>
    ...
    public struct SpinWait
    {
        ...
        /// forced context switch.</see></value>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="condition">A delegate to be executed over and over until it returns true.
        /// <exception cref="ArgumentNullException">The <paramref name="condition"> argument is null.</paramref></exception>
        ...
        /// <see cref="System.Int32.MaxValue">.</see></paramref></exception>
        ...
        /// </summary>
        /// <param name="condition">A delegate to be executed over and over until it returns true.
        /// <param name="millisecondsTimeout">The number of milliseconds to wait, or <see cref="System.Threading.Timeout.Infinite"> (-1) to wait indefinitely.
        /// <returns>True if the condition is satisfied within the timeout; otherwise, false</returns>
        /// <exception cref="ArgumentNullException">The <paramref name="condition"> argument is null.</paramref></exception>
